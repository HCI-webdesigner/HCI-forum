...
function linkedSelect(){
	...
	list2.push(['PHP','2','6']);
	list2.push(['JSP','2','7']);
	list2.push(['Python','2','8']);
	list2.push(['框架','2','9']);
	list2.push(['Android','3','10']);
	list2.push(['IOS','3','11']);
	list2.push(['系统运维','4','12']);
	list2.push(['系统安全','4','13']);
	list2.push(['资料','5','14']);
	list2.push(['书籍','5','15']);
	list2.push(['软件','5','16']);
	list2.push(['其他','5','17']);
	list2.push(['实习资讯','6','18']);
	list2.push(['求职信息','6','19']);
	list2.push(['经验交流','6','20']);
	list2.push(['讲座活动','6','21']);
	list2.push(['其他','6','22']);
	list2.push(['情感','7','23']);
	list2.push(['娱乐','7','24']);
	list2.push(['其他','7','25']);
